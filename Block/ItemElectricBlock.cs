...
namespace Mekiasm
{
    public class ItemElectricBlock : Block,IMekElectricBlock,IPaintableBlock
    {
        ...
        public MekElectricElement createMekElement(SubsystemMekElectricSystem subsystemElectricity, int value, int x, int y, int z)
        {
